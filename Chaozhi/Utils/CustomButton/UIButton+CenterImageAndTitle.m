...
- (void)verticalCenterImageAndTitle:(CGFloat)spacing
{
    ...
    CGFloat height = imageSize.height +titleSize.height+spacing;
    
    // lower the text and push it left to center it
    self.titleEdgeInsets = UIEdgeInsetsMake((self.frame.size.height-height)/2.0, - imageSize.width, - (imageSize.height + spacing/2), 0.0);
