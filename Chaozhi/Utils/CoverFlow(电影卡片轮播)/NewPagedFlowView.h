...
/**
 网络图片数据源
 */
@property (nonatomic, strong) NSMutableArray *urlImageDataSource;
/**
 本地图片数据源
 */
...
/**
 图片比例
 */
@property (nonatomic, assign) CGFloat imgProportion;

/**
 是否显示pagecontroll NO不显示page yes显示page
 */
@property (nonatomic, assign) BOOL hiddenPageControll;
/**
 图片显示模式 默认平铺拉伸图片
 */
